...
/// Main routine
/* This code is placed inside a closure to ensure that variables
 * created here are not accidentally accessed by the rest of the
 * code. Exceptions to this should be declared outside this main
 * closure, e.g., the global debug variable.
 */
let main = {
