#!/bin/bash
# This script plots the mean RSU saturation on 'signalAndSaturationEvolution'.
...
swift $(dirname $0)/analyzeColumnByTime.swift statfilelist meanSat > ${VISDIR}/${VISNAME}.data
rm -rf statfilelist
