...
binLoop: for bin in bins {
	...
	outputDictionary[bin] = SubDecisionEntry(dNew: accumulatedDecision.dNew		/ Double(decisions),
	                                         dBoost: accumulatedDecision.dBoost	/ Double(decisions),
	                                         dSat: accumulatedDecision.dSat		/ Double(decisions),
	                                         dScore: accumulatedDecision.dScore	/ Double(decisions))
}
